...
<div class="container mx-auto px-4 py-6 max-w-3xl">
    <div class="flex items-center gap-2 mb-6">
        ...
        <div>
            <h1 class="text-2xl font-bold">Tambah Jadwal Dokter</h1>
            <p class="text-base-content/70">Tambahkan jadwal praktik dokter baru</p>
        </div>
    </div>
    ...
    <form action="<?= base_url('schedules') ?>" method="POST" class="space-y-6">
        <?= csrf_field() ?>
            ...
            <div class="card-body">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="form-control">
                        ...
                        <input type="number" name="quota" value="<?= old('quota', 20) ?>" placeholder="20" min="1" class="input input-bordered w-full" />
                    </div>
                    ...
                    <div class="form-control">
                        ...
                        <input type="time" name="start_time" value="<?= old('start_time') ?>" class="input input-bordered w-full <?= session('errors.start_time') ? 'input-error' : '' ?>" required />
                    </div>
                    ...
                    <div class="form-control">
                        ...
                        <input type="time" name="end_time" value="<?= old('end_time') ?>" class="input input-bordered w-full <?= session('errors.end_time') ? 'input-error' : '' ?>" required />
                    </div>
                </div>
            </div>
        </div>
