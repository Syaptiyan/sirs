...
<div class="space-y-6">
    <div>
        <div class="text-sm breadcrumbs">
            <ul>
                ...
                <li>Registrasi Baru</li>
            </ul>
        </div>
        <h1 class="text-2xl font-bold mt-2">Registrasi Pasien Baru</h1>
        <p class="text-base-content/70">Isi data diri pasien untuk registrasi baru</p>
    </div>
    ...
    <form method="POST" action="<?= site_url('patients') ?>" class="card bg-base-100 shadow-sm">
        <div class="card-body space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div class="form-control">
                    ...
                    <input type="text" name="mrn" class="input input-bordered <?= session('errors.mrn') ? 'input-error' : '' ?>"
                           value="<?= old('mrn') ?>" placeholder="Otomatis jika kosong" />
                </div>
                <div class="form-control">
                ...
                <div class="form-control">
                    ...
                    <input type="text" name="nik" class="input input-bordered <?= session('errors.nik') ? 'input-error' : '' ?>"
                           value="<?= old('nik') ?>" maxlength="16" pattern="[0-9]{16}" placeholder="16 digit NIK" required />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="form-control">
                    ...
                    <input type="text" name="occupation" class="input input-bordered" value="<?= old('occupation') ?>" />
                </div>
                <div class="form-control">
            ...
            <div class="flex justify-end gap-3">
                <a href="<?= site_url('patients') ?>" class="btn btn-ghost">Batal</a>
